...
var Footer = function () {
    return (<footer className="bg-jet-black text-pure-white py-12">
      <div className="container-custom">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            'Pickup & Delivery',
            'Rush Service'
        ].map(function (item) { return (<li key={item}>
                  <a href="#services" className="text-gray-400 hover:text-electric-blue transition-colors duration-300">
                    {item}
                  </a>
                </li>); })}
            </ul>
