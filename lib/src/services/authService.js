...
var registerUser = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, auth_1.createUserWithEmailAndPassword)(firebaseConfig_1.auth, email, password)];
            case 1:
...
var loginUser = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, auth_1.signInWithEmailAndPassword)(firebaseConfig_1.auth, email, password)];
            case 1:
                userCredential = _a.sent();
                return [2 /*return*/, userCredential.user];
        }
...
// Logout user
var logoutUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
